"""
Shared Configuration for IE1KG9041 Conversion Pipeline
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE1KG9041")

# Input: DOC files organized by VE folder
SOURCE_DIR = BASE_DIR / "IE1KG9041" / "sources"

# Intermediate: RTF files (after Word conversion)
RTF_DIR = BASE_DIR / "IE1KG9041" / "rtf"

# Output: Final XML files and source copies
OUTPUT_DIR = BASE_DIR / "IE1KG9041_output"
