"""
Shared Configuration for IE30199 Conversion Pipeline

This module contains all path configurations and constants used across
the conversion scripts. IE30199 has DOCX files directly in toprocess,
so no DOC to DOCX conversion is needed.
"""
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE30199")

# Input: DOCX files in toprocess folder (directly, no subfolder nesting)
TOPROCESS_DIR = BASE_DIR / "IE30199" / "toprocess"

# Output: Final XML files and source copies
OUTPUT_DIR = BASE_DIR / "IE30199_output"
...
def extract_ve_id_from_folder(folder_name: str) -> str:
    """
    Extract VE ID from folder name like 'IE30199-VE5CN21' -> 'VE5CN21'.
...
def get_ut_id(ve_id: str, sequence: int = 1) -> str:
    ...
    Examples:
        VE5CN21, 1 -> UT5CN21_0001
        VE5CN21, 2 -> UT5CN21_0002
    """
