...
python convert.py --ie-id IE1KG1796

# Adjust number of parallel workers (for faster processing)
python convert.py --ie-id IE1KG1796 --workers 4
...
python convert.py --input-dir /path/to/rtf --ie-id IE1KG1796 --workers 8
```
...
python convert.py --ie-id IE1KG796 --workers 4 --input-dir /path/to/rtf --yes
```
...
python rtf_check_fix.py --ie-id IE1KG1796

# Check only (no fixing)
python rtf_check_fix.py --ie-id IE1KG1796 --no-fix
...
python export_outputs.py --ie-id IE1KG1796
...
# Combine options
python export_outputs.py --ie-id IE1KG1796 --output-dir /path/to/export
```
...
# Export specific collection
python export_outputs.py --ie-id IE1KG796
...
# Combine options
python3 export_outputs.py --ie-id IEKG1796 --output-dir /path/to/export
```
