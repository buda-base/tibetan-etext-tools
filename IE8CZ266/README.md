...
```bash
python convert_doc_to_rtf.py --ie-id IE8CZ266
python convert_doc_to_rtf.py --ie-id IE8CZ266 --method drive
python convert_doc_to_rtf.py --ie-id IE8CZ266 --remove-original
```
...
```bash
python convert.py --ie-id IE8CZ266 --test-first
python convert.py --rtf-dir ../rtf/IE8CZ266 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE8CZ266 --single yourfile.rtf
python convert.py --ie-id IE8CZ266 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE8CZ266
python rtf_check_fix.py --ie-id IE8CZ266 --no-fix
python rtf_check_fix.py --ie-id IE8CZ266 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE8CZ266
python export_outputs.py --ie-id IE8CZ266 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE8CZ266`
2. RTF→XML: `python convert.py --ie-id IE8CZ266 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE8CZ266`
4. Export: `python export_outputs.py --ie-id IE8CZ266`
