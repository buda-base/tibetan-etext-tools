"""
Shared Configuration for IE1KG2170 Conversion Pipeline
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE1KG2170")

# Input: DOC files organized by VE folder
SOURCE_DIR = BASE_DIR / "IE1KG2170" / "sources"

# Intermediate: RTF files (after Word conversion)
RTF_DIR = BASE_DIR / "IE1KG2170" / "rtf"

# Output: Final XML files and source copies
OUTPUT_DIR = BASE_DIR / "IE1KG2170_output"
