...
python convert.py --ie-id IE1KG1802

# Adjust number of parallel workers (for faster processing)
python convert.py --ie-id IE1KG1802 --workers 4
...
python convert.py --input-dir /path/to/rtf --ie-id IE1KG1802 --workers 8
```
...
python convert.py --ie-id IE1KG1802 --workers 4 --input-dir /path/to/rtf --yes
```
...
python rtf_check_fix.py --ie-id IE1KG1802

# Check only (no fixing)
python rtf_check_fix.py --ie-id IE1KG1802 --no-fix

# Save report
python rtf_check_fix.py --ie-id IE1KG1802 --output report.txt
```
...
python export_outputs.py --ie-id IE1KG1802
...
# Combine options
python export_outputs.py --ie-id IE1KG1802 --output-dir /path/to/export
```
...
# Combine options
python3 export_outputs.py --ie-id IE1KG1802 --output-dir /path/to/export
```

---

## 4. Clean XML Files (`clean_xml.py`)

### Usage

```bash
# Clean all XML files for a specific IE collection (dry run - preview changes)
python3 clean_xml.py --ie-id IE1KG1802 --dry-run

# Clean all XML files for a specific IE collection
python3 clean_xml.py --ie-id IE1KG1802

# Clean a specific file by name within an IE collection (finds file automatically)
python3 clean_xml.py --ie-id IE1KG1802 --file UT1KG1802_001_0005.xml

# Clean a specific XML file using full path
python3 clean_xml.py --file rtf/IE1KG1802/IE1KG1802_output/archive/VE1KG1802_001/UT1KG1802_001_0005.xml

# Clean all files in a custom directory
python3 clean_xml.py --directory rtf/IE1KG1802/IE1KG1802_output/archive
```

**What it does:**
- Removes sequences of dots (e.g., `..............`)
- Removes patterns like `«£¨38£©`, `«£¨3»9£©`, etc., keeping only `«`
- Cleans up remaining unwanted characters

**Note:** When using `--ie-id` with `--file`, the script will automatically search for the file by name within the IE collection's archive directory.
