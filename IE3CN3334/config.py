"""
Shared Configuration for IE3CN3334 Conversion Pipeline

This module contains all path configurations and constants used across
the conversion scripts. IE3CN3334 has DOC files that need conversion to DOCX,
then to XML. Files are Unicode (no Dedris conversion needed).
"""
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE3CN3334")

# Input: DOC files in toprocess folder (in VE folders)
TOPROCESS_DIR = BASE_DIR / "IE3CN3334" / "toprocess"

# Intermediate: DOCX files (after Word conversion from DOC)
DOCX_DIR = BASE_DIR / "IE3CN3334" / "docx"

# Output: Final XML files and source copies
OUTPUT_DIR = BASE_DIR / "IE3CN3334_output"
...
def extract_ve_id_from_folder(folder_name: str) -> str:
    """
    Extract VE ID from folder name like 'IE3CN3334-VE5CN1' -> 'VE5CN1'.
...
def get_ut_id(ve_id: str, sequence: int = 1) -> str:
    ...
    Examples:
        VE5CN1, 1 -> UT5CN1_0001
        VE5CN1, 2 -> UT5CN1_0002
    """
