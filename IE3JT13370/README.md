# IE3JT13370 - Batch RTF to TEI XML Converter

Convert Tibetan RTF documents into TEI XML format.

## Overview

This collection-specific converter processes RTF files from the IE3JT13370 collection, converting them to TEI XML format.
...
└── IE3JT13370/
    └── IE3JT13370_output/
        ├── archive/
        │   └── VE3JT13370_001/
        │       ├── UT3JT13370_001_0001.xml
        │       ├── UT3JT13370_001_0002.xml
        │       └── ...
        └── sources/
            └── VE3JT13370_001/
                ├── volume_001.rtf
...
Process only the IE3JT13370 collection:
```bash
python convert.py --ie-id IE3JT13370
```
...
- `VE3JT13370_001`, index 0 → `UT3JT13370_001_0001`
- `VE3JT13370_001`, index 1 → `UT3JT13370_001_0002`
