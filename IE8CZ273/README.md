...
```bash
python convert_doc_to_rtf.py --ie-id IE8CZ273
python convert_doc_to_rtf.py --ie-id IE8CZ273 --method drive
python convert_doc_to_rtf.py --ie-id IE8CZ273 --remove-original
```
...
```bash
python convert.py --ie-id IE8CZ273 --test-first
python convert.py --rtf-dir ../rtf/IE8CZ273 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE8CZ273 --single yourfile.rtf
python convert.py --ie-id IE8CZ273 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE8CZ273
python rtf_check_fix.py --ie-id IE8CZ273 --no-fix
python rtf_check_fix.py --ie-id IE8CZ273 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE8CZ273
python export_outputs.py --ie-id IE8CZ273 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE8CZ273`
2. RTF→XML: `python convert.py --ie-id IE8CZ273 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE8CZ273`
4. Export: `python export_outputs.py --ie-id IE8CZ273`
