...
```bash
python convert_doc_to_rtf.py --ie-id IE3KG671
python convert_doc_to_rtf.py --ie-id IE3KG671 --method drive
python convert_doc_to_rtf.py --ie-id IE3KG671 --remove-original
```
...
```bash
python convert.py --ie-id IE3KG671 --test-first
python convert.py --rtf-dir ../rtf/IE3KG671 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE3KG671 --single yourfile.rtf
python convert.py --ie-id IE3KG671 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE3KG671
python rtf_check_fix.py --ie-id IE3KG671 --no-fix
python rtf_check_fix.py --ie-id IE3KG671 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE3KG671
python export_outputs.py --ie-id IE3KG671 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE3KG671`
2. RTF→XML: `python convert.py --ie-id IE3KG671 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE3KG671`
4. Export: `python export_outputs.py --ie-id IE3KG671`
