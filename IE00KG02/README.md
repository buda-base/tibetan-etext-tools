# Convert RTF files from IE00KG02 to TEI XML format.
...
python convert.py --base-dir /path/to/IE00KG02
```
...
<teiHeader>
  <fileDesc>
    ...
    <sourceDesc>
      <bibl>
        <idno type="src_path">VE1ER669/example_file.rtf</idno>
        <idno type="src_sha256">abc123...</idno>
        <idno type="bdrc_ie">http://purl.bdrc.io/resource/IE00KG02</idno>
  ...
  <encodingDesc>
    <p>The TEI header does not contain any bibliographical data. It is instead accessible through the <ref target="http://purl.bdrc.io/resource/IE00KG02">record in the BDRC database</ref>.</p>
  </encodingDesc>
</teiHeader>
<text>
<body xml:lang="bo">
<p><hi rend="head">༈ མཉམ་མེད་སྟོན་མཆོག་ཐུབ་པའི་དབང་པ་ོལ་ན་མ།ོ
<lb/>༄༅། །ཐེག་པ་ཆེན་པོ་རྒྱུད་བླ་མའི་བསྟན་བཅོས་ཀྱི་འགྲེལ་བཤད།</hi></p>
</body>
</text>
</TEI>
```
...
- Default base directory: `/Users/tenzinmonlam/Documents/dharmaduta/file_convert_3/IE00KG02`
