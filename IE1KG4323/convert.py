#!/usr/bin/env python3
"""
Convert RTF files from IE1KG4323 to TEI XML format.
...
Input structure:
    toprocess/IE1KG4323-VE1KG4323_001/SPUN000.rtf
    toprocess/IE1KG4323-VE1KG4323_001/SPUN001_xxx.rtf
    ...

Output structure:
    IE1KG4323_OUTPUT/archive/VE1KG4323_001/UT1KG4323_001_0001.xml
    IE1KG4323_OUTPUT/archive/VE1KG4323_001/UT1KG4323_001_0002.xml
    IE1KG4323_OUTPUT/sources/VE1KG4323_001/SPUN000.rtf
    ...
...
OUTPUT_DIR = BASE_DIR / "IE1KG4323_OUTPUT"
...
def get_volume_folders() -> list:
    ...
    Each folder is named like: IE1KG4323-VE1KG4323_001
    ...
    for folder in TOPROCESS_DIR.iterdir():
        if folder.is_dir() and folder.name.startswith(f'{IE_ID}-'):
            ve_id = folder.name.replace(f'{IE_ID}-', '')  # "VE1KG4323_001"
...
def get_ut_id(ve_id: str, file_index: int) -> str:
    ...
    VE1KG4323_001, index 0 -> UT1KG4323_001_0001
    VE1KG4323_001, index 1 -> UT1KG4323_001_0002
    """
    ve_suffix = ve_id[2:]  # Remove 'VE' prefix -> "1KG4323_001"
...
def convert_rtf_to_tei(rtf_path: Path, ve_id: str, ut_id: str, src_path: str) -> str:
    ...
    Args:
        ...
        ve_id: Volume Entity ID (e.g., "VE1KG4323_001")
        ut_id: Unit Text ID (e.g., "UT1KG4323_001_0001")
        src_path: Source path for XML header (e.g., "sources/VE1KG4323_001/SPUN000.rtf")
...
if __name__ == "__main__":
    ...
    DEBUG_MODE = False
    DEBUG_VOLUME = "VE1KG4323_001"  # First volume for testing
