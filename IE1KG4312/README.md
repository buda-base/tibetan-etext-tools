...
```bash
python convert_doc_to_rtf.py --ie-id IE1KG4312
python convert_doc_to_rtf.py --ie-id IE1KG4312 --method drive
python convert_doc_to_rtf.py --ie-id IE1KG4312 --remove-original
```
...
```bash
python convert.py --ie-id IE1KG4312 --test-first
python convert.py --rtf-dir ../rtf/IE1KG4312 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE1KG4312 --single yourfile.rtf
python convert.py --ie-id IE1KG4312 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE1KG4312
python rtf_check_fix.py --ie-id IE1KG4312 --no-fix
python rtf_check_fix.py --ie-id IE1KG4312 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE1KG4312
python export_outputs.py --ie-id IE1KG4312 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE1KG4312`
2. RTF→XML: `python convert.py --ie-id IE1KG4312 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE1KG4312`
4. Export: `python export_outputs.py --ie-id IE1KG4312`
