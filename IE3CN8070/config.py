"""
Shared Configuration for IE3CN8070 Conversion Pipeline

This module contains all path configurations and constants used across
the conversion scripts. IE3CN8070 has DOC files that need conversion to PDF,
then to XML.
...
def extract_ve_id_from_folder(folder_name: str) -> str:
    """
    Extract VE ID from folder name like 'IE3CN8070-VE5CN123' -> 'VE5CN123'.
