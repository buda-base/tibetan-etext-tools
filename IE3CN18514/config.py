"""
Shared Configuration for IE3CN18514 Conversion Pipeline

This module contains all path configurations and constants used across
the conversion scripts. IE3CN18514 has DOCX files in VE folders.
"""
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE3CN18514")

# Input: DOCX files in toprocess folder (in VE folders)
TOPROCESS_DIR = BASE_DIR / "IE3CN18514" / "toprocess"

# Output: Final XML files and source copies
OUTPUT_DIR = BASE_DIR / "IE3CN18514_output"
...
def extract_ve_id_from_folder(folder_name: str) -> str:
    """
    Extract VE ID from folder name like 'IE3CN18514-VE1ER4' -> 'VE1ER4'.
...
def get_ut_id(ve_id: str, sequence: int = 1) -> str:
    ...
    Examples:
        VE1ER4, 1 -> UT1ER4_0001
        VE1ER4, 2 -> UT1ER4_0002
    """
