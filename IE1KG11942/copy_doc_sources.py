...
This script copies .doc files from the original sources directory (sources/16_NGAL/)
to the corresponding IE1KG11942_OUTPUT/sources/VE*/ folders, matching by filename
prefix (e.g., NGAL026) with the RTF files already there.

This handles cases where filenames differ due to Windows truncation/encoding issues:
- RTF: NGAL026_སྡེ་གཞུང་...རི.rtf
- DOC: NGAL026_སྡེ་གཞུང་...རི#8532.doc
...
ORIGINAL_SOURCES_DIR = BASE_DIR / "sources" / "16_NGAL"
OUTPUT_SOURCES_DIR = BASE_DIR / "IE1KG11942_OUTPUT" / "sources"
...
def copy_doc_files():
    ...
    for ve_folder in sorted(OUTPUT_SOURCES_DIR.iterdir()):
        ...
        for rtf_file in sorted(ve_folder.glob("*.rtf")):
            # Extract prefix (e.g., "NGAL026" from "NGAL026_སྡེ་གཞུང་...rtf")
