...
Usage:
    # Process with default base directory:
    python convert.py
    
    # Process with custom base directory:
    python convert_new.py --base-dir /path/to/IE00KG0537
"""
...
IE_ID = "IE00KG0537"
DEFAULT_BASE_DIR = Path("/Users/tenzinmonlam/Documents/dharmaduta/file_convert_3/IE00KG0537")
...
def convert_rtf_to_tei(rtf_path: Path, ie_id: str, ve_id: str, ut_id: str, src_path: str) -> str:
    ...
    # Pattern: <lb/>\n</hi>\n<lb/> becomes </hi>\n<lb/>
    body_content = re.sub(r'<lb/>\s*</hi>\s*<lb/>', r'</hi>\n<lb/>', body_content)
...
def main():
    parser = argparse.ArgumentParser(
        description=f"Convert {IE_ID} RTF files to TEI XML"
    )
    ...
    parser.add_argument(
        ...
        help=f"Base directory containing sources folder (default: {DEFAULT_BASE_DIR})"
    )
