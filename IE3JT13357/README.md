...
```bash
python convert_doc_to_rtf.py --ie-id IE3JT13357
python convert_doc_to_rtf.py --ie-id IE3JT13357 --method drive
python convert_doc_to_rtf.py --ie-id IE3JT13357 --remove-original
```
...
```bash
python convert.py --ie-id IE3JT13357 --test-first
python convert.py --rtf-dir ../rtf/IE3JT13357 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE3JT13357 --single yourfile.rtf
python convert.py --ie-id IE3JT13357 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE3JT13357
python rtf_check_fix.py --ie-id IE3JT13357 --no-fix
python rtf_check_fix.py --ie-id IE3JT13357 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE3JT13357
python export_outputs.py --ie-id IE3JT13357 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE3JT13357`
2. RTF→XML: `python convert.py --ie-id IE3JT13357 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE3JT13357`
4. Export: `python export_outputs.py --ie-id IE3JT13357`
