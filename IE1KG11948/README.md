...
python convert.py --ie-id IE1KG11947

# Adjust number of parallel workers (for faster processing)
python convert.py --ie-id IE1KG11947 --workers 4
...
python convert.py --input-dir /path/to/rtf --ie-id IE1KG11947 --workers 8
```
...
python convert.py --ie-id IE1KG11947 --workers 4 --input-dir /path/to/rtf --yes
```
...
python rtf_check_fix.py --ie-id IE1KG11947

# Check only (no fixing)
python rtf_check_fix.py --ie-id IE1KG11947 --no-fix

# Save report
python rtf_check_fix.py --ie-id IE1KG11947 --output report.txt
```
...
python export_outputs.py --ie-id IE1KG11947
...
# Combine options
python export_outputs.py --ie-id IE1KG11947 --output-dir /path/to/export
```
...
# Combine options
python3 export_outputs.py --ie-id IE1KG11947 --output-dir /path/to/export
```
