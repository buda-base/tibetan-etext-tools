"""
Shared Configuration for IE3CN5624 Conversion Pipeline

This module contains all path configurations and constants used across
the conversion scripts. IE3CN5624 has DOCX files in VE folders (Unicode source).
"""
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE3CN5624")

# Input: DOCX files in toprocess folder (in VE folders)
TOPROCESS_DIR = BASE_DIR / "IE3CN5624" / "toprocess"

# Output: Final XML files and source copies
OUTPUT_DIR = BASE_DIR / "IE3CN5624_output"
...
def extract_ve_id_from_folder(folder_name: str) -> str:
    """
    Extract VE ID from folder name like 'IE3CN5624-VE5CN139' -> 'VE5CN139'.
...
def get_ut_id(ve_id: str, sequence: int = 1) -> str:
    ...
    Examples:
        VE5CN139, 1 -> UT5CN139_0001
        VE5CN139, 2 -> UT5CN139_0002
    """
