# IE3JT13377 - Batch RTF to TEI XML Converter

Convert Tibetan RTF documents into TEI XML format.

## Overview

This collection-specific converter processes RTF files from the IE3JT13377 collection, converting them to TEI XML format.
...
└── IE3JT13377/
    └── IE3JT13377_output/
        ├── archive/
        │   └── VE3JT13377_001/
        │       ├── UT3JT13377_001_0001.xml
        │       ├── UT3JT13377_001_0002.xml
        │       └── ...
        └── sources/
            └── VE3JT13377_001/
                ├── volume_001.rtf
...
Process only the IE3JT13377 collection:
```bash
python convert.py --ie-id IE3JT13377
```
...
- `VE3JT13377_001`, index 0 → `UT3JT13377_001_0001`
- `VE3JT13377_001`, index 1 → `UT3JT13377_001_0002`
