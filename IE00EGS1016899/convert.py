#!/usr/bin/env python3
"""
Convert RTF files from IE00EGS1016899 (Shakchog Collection) to TEI XML format.
...
Input structure:
    toprocess/IE00EGS1016899-VE3KG268/SHAK000.rtf
    toprocess/IE00EGS1016899-VE3KG268/SHAK001.rtf
    ...

Output structure:
    archive/VE3KG268/UT3KG268_0001.xml
    archive/VE3KG268/UT3KG268_0002.xml
    sources/VE3KG268/SHAK000.rtf
    ...
...
IE_ID = "IE00EGS1016899"

# Paths
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE00EGS1016899")
TOPROCESS_DIR = BASE_DIR / "IE00EGS1016899" / "toprocess"
OUTPUT_DIR = BASE_DIR / "IE00EGS1016899_output"
...
def get_ut_id(ve_id: str, file_index: int) -> str:
    ...
    VE3KG268, index 0 -> UT3KG268_0001
    VE3KG268, index 1 -> UT3KG268_0002
    """
...
if __name__ == "__main__":
    ...
    DEBUG_MODE = False
    DEBUG_VOLUME = "VE3KG268"  # First volume for testing
