#!/usr/bin/env python3
"""
Convert PDF files from IE4PD2082 (JKW-KABAB) to TEI XML format.
...
def convert_ie4pd2082(input_path: str, output_path: str):
    """
    Main conversion function for IE4PD2082.
    
    Args:
        input_path: Path to input folder (IE4PD2082_INPUT)
        output_path: Path to output folder (IE4PD2082)
    """
...
def main():
    if len(sys.argv) != 3:
        ...
        print(f"\nExample:")
        print(f"  python {sys.argv[0]} /path/to/IE4PD2082_INPUT /path/to/IE4PD2082")
        sys.exit(1)
    
    input_folder = sys.argv[1]
    output_folder = sys.argv[2]
    
    convert_ie4pd2082(input_folder, output_folder)
