# IE4PD2082 (JKW-KABAB) PDF to TEI Converter

This script converts PDF files from IE4PD2082 (JKW-KABAB collection) to TEI XML format.
...
IE4PD2082_INPUT/
  sources/
    JKW-KABAB-Volume-01.pdf
    JKW-KABAB-Volume-02.pdf
    ...
    JKW-KABAB-Volume-22.pdf
  toprocess/
    IE4PD2082-VE5CN1049/
    IE4PD2082-VE5CN1050/
    ...
...
- **sources/**: Contains the source PDF files (22 volumes)
...
- **IE4PD2082.csv**: Outline CSV with volume metadata
...
```bash
python convert_pdf.py /path/to/IE4PD2082_INPUT /path/to/IE4PD2082_OUTPUT
```
...
|--------|----------|-------|
| 01 | JKW-KABAB-Volume-01.pdf | VE5CN1049 |
| 02 | JKW-KABAB-Volume-02.pdf | VE5CN1050 |
| ... | ... | ... |
| 22 | JKW-KABAB-Volume-22.pdf | VE5CN1070 |

## Notes

- The JKW-KABAB PDFs may have invisible text outside the visible page area. py-tiblegenc handles this by using `CropBox` instead of `MediaBox` for page dimensions.
