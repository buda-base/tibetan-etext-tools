...
```bash
python convert_doc_to_rtf.py --ie-id IE3CN4349
python convert_doc_to_rtf.py --ie-id IE3CN4349 --method drive
python convert_doc_to_rtf.py --ie-id IE3CN4349 --remove-original
```
...
```bash
python convert.py --ie-id IE3CN4349 --test-first
python convert.py --rtf-dir ../rtf/IE3CN4349 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE3CN4349 --single yourfile.rtf
python convert.py --ie-id IE3CN4349 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE3CN4349
python rtf_check_fix.py --ie-id IE3CN4349 --no-fix
python rtf_check_fix.py --ie-id IE3CN4349 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE3CN4349
python export_outputs.py --ie-id IE3CN4349 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE3CN4349`
2. RTF→XML: `python convert.py --ie-id IE3CN4349 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE3CN4349`
4. Export: `python export_outputs.py --ie-id IE3CN4349`
