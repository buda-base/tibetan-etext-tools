...
python convert.py --ie-id IE1KG1803

# Adjust number of parallel workers (for faster processing)
python convert.py --ie-id IE1KG1803 --workers 4
...
python convert.py --input-dir /path/to/rtf --ie-id IE1KG1803 --workers 8
```
...
python convert.py --ie-id IE1KG1803 --workers 4 --input-dir /path/to/rtf --yes
```
...
python rtf_check_fix.py --ie-id IE1KG1803

# Check only (no fixing)
python rtf_check_fix.py --ie-id IE1KG1803 --no-fix

# Save report
python rtf_check_fix.py --ie-id IE1KG1803 --output report.txt
```
...
python export_outputs.py --ie-id IE1KG1803
...
# Combine options
python export_outputs.py --ie-id IE1KG1803 --output-dir /path/to/export
```
...
# Combine options
python3 export_outputs.py --ie-id IE1KG1803 --output-dir /path/to/export
```
...
python3 clean_xml.py --ie-id IE1KG1803 --dry-run

# Clean all XML files for a specific IE collection
python3 clean_xml.py --ie-id IE1KG1803

# Clean a specific file by name within an IE collection (finds file automatically)
python3 clean_xml.py --ie-id IE1KG1803 --file UT1KG1802_001_0005.xml
