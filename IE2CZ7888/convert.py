#!/usr/bin/env python3
"""
Convert intermediate XML files from IE2CZ7888 to TEI XML format.

This script converts intermediate XML files (with <text>, <pb>, <lb/> tags)
to proper TEI XML format with metadata headers.

Input structure:
    xml/IE2CZ7888/IE2CZ7888/sources/IE2CZ7888-VE5CN659/W2CZ7888_1-764.docx
    xml/IE2CZ7888/IE2CZ7888/W2CZ7888_I1KG2937_parsed.xml

Output structure:
    xml_output/IE2CZ7888/archive/VE5CN659/UT5CN659_0001.xml
    xml_output/IE2CZ7888/sources/VE5CN659/W2CZ7888_1-764.docx
    xml_output/IE2CZ7888/sources/VE5CN659/W2CZ7888_I1KG2937_parsed.xml
...
IE_ID = "IE2CZ7888"
W_ID = "W2CZ7888"  # Work ID pattern for XML files

# Paths
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944")
INPUT_DIR = BASE_DIR / "xml" / "IE2CZ7888" / "IE2CZ7888"
SOURCES_DIR = INPUT_DIR / "sources"
OUTPUT_DIR = BASE_DIR / "xml_output" / "IE2CZ7888"
...
def get_volume_data() -> list:
    ...
    Each folder in sources is named like: IE2CZ7888-VE5CN659
    ...
    for folder in SOURCES_DIR.iterdir():
        if folder.is_dir() and folder.name.startswith(f'{IE_ID}-'):
            ve_id = folder.name.replace(f'{IE_ID}-', '')  # "VE5CN659"
...
def get_ut_id(ve_id: str, file_index: int = 0) -> str:
    ...
    VE5CN659, index 0 -> UT5CN659_0001
    """
    ve_suffix = ve_id[2:]  # Remove 'VE' prefix -> "5CN659"
...
def convert_xml_to_tei(xml_path: Path, ve_id: str, ut_id: str, 
    ...
    Args:
        ...
        ve_id: Volume Entity ID (e.g., "VE5CN659")
        ut_id: Unit Text ID (e.g., "UT5CN659_0001")
        doc_path: Path to source doc file (for SHA256 calculation)
        src_path: Source path for XML header (e.g., "sources/VE5CN659/W2CZ7888_1-764.docx")
    ...
    title = xml_path.stem  # W2CZ7888_I1KG2937_parsed
...
if __name__ == "__main__":
    logger.info("=== IE2CZ7888 XML Conversion ===")
