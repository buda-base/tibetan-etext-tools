...
This version includes important fixes for IE1KG13014 conversion:

1. **Date Format Preservation**: Hyphens between Tibetan numerals are now preserved as ASCII hyphens
   - Input: `1808-1887` in Dedris font
   - Output: `༡༨༠༨-༡༨༨༧` (with ASCII hyphen)
   - Previously: `༡༨༠༨་༡༨༨༧` (with Tibetan tsheg)

2. **Table of Contents Dots**: Dots are preserved as ASCII periods, not converted to Tibetan letters
   - Input: `.........................................`
   - Output: `.........................................` (preserved)
   - Previously: `དདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདདད` (incorrect conversion)

3. **Symbol Cleanup**: RTF special symbols are automatically removed
   - Input: `[2` symbol in RTF → `ªê` in output
   - Output: Symbol removed automatically
   - Example: `ªêབསྒྲུབ་བྱའི་ལམ།` → `བསྒྲུབ་བྱའི་ལམ།`
...
- **Date Format Fix**: Hyphens between Tibetan numerals are preserved as ASCII hyphens
  - Example: `1808-1887` → `༡༨༠༨-༡༨༨༧` (not `༡༨༠༨་༡༨༨༧`)
  - Tibetan tsheg (་) is replaced with ASCII hyphen (-) when between digits
- **Table of Contents Dots**: Dots in table of contents are preserved as ASCII periods
  - Sequences like `.........` remain unchanged (not converted to Tibetan letters)
- **Symbol Cleanup**: RTF symbols are removed from output
  - Characters like `ªê` (from `[2` symbol) are automatically removed
...
- Special handling for ASCII-only text in Dedris fonts (dots, spaces, tabs)
