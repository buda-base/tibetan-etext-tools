...
```bash
python convert_doc_to_rtf.py --ie-id  IE9935
python convert_doc_to_rtf.py --ie-id  IE9935 --method drive
python convert_doc_to_rtf.py --ie-id  IE9935 --remove-original
```
...
```bash
python convert.py --ie-id  IE9935 --test-first
python convert.py --rtf-dir ../rtf/ IE9935 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id  IE9935 --single yourfile.rtf
python convert.py --ie-id  IE9935 --all
```
...
```bash
python rtf_check_fix.py --ie-id  IE9935
python rtf_check_fix.py --ie-id  IE9935 --no-fix
python rtf_check_fix.py --ie-id  IE9935 --output report.txt
```
...
```bash
python export_outputs.py --ie-id  IE9935
python export_outputs.py --ie-id  IE9935 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id  IE9935`
2. RTF→XML: `python convert.py --ie-id  IE9935 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id  IE9935`
4. Export: `python export_outputs.py --ie-id  IE9935`
