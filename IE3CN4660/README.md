...
```bash
python convert_doc_to_rtf.py --ie-id IE3CN4345
python convert_doc_to_rtf.py --ie-id IE3CN4345 --method drive
python convert_doc_to_rtf.py --ie-id IE3CN4345 --remove-original
```
...
```bash
python convert.py --ie-id IE3CN4345 --test-first
python convert.py --rtf-dir ../rtf/IE3CN4345 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE3CN4345 --single yourfile.rtf
python convert.py --ie-id IE3CN4345 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE3CN4345
python rtf_check_fix.py --ie-id IE3CN4345 --no-fix
python rtf_check_fix.py --ie-id IE3CN4345 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE3CN4345
python export_outputs.py --ie-id IE3CN4345 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE3CN4345`
2. RTF→XML: `python convert.py --ie-id IE3CN4345 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE3CN4345`
4. Export: `python export_outputs.py --ie-id IE3CN4345`
