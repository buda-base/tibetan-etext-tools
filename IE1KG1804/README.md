...
python convert.py --ie-id IE1KG1804 --workers 4
...
python convert.py --input-dir /path/to/rtf --ie-id IE1KG1804 --workers 8
```
...
python convert.py --ie-id IE1KG1804 --workers 4 --input-dir /path/to/rtf --yes
```
...
# Save report
python rtf_check_fix.py --ie-id IE1KG1804 --output report.txt
```
...
# Combine options
python export_outputs.py --ie-id IE1KG1804 --output-dir /path/to/export
```
...
# Combine options
python3 export_outputs.py --ie-id IE1KG1804 --output-dir /path/to/export
```
