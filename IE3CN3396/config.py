"""
Shared Configuration for IE3CN3396 Conversion Pipeline
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE3CN3396")

# Input: DOC files organized by VE folder
SOURCE_DIR = BASE_DIR / "IE3CN3396" / "sources"

# Intermediate: RTF files (after Word conversion)
RTF_DIR = BASE_DIR / "IE3CN3396" / "rtf"

# Output: Final XML files and source copies
OUTPUT_DIR = BASE_DIR / "IE3CN3396_output"
