...
and outputs DOCX files to docx/{VE_ID}/ preserving the folder structure.

Usage:
    python 1_convert_doc_to_docx.py           # Convert all DOC files
    python 1_convert_doc_to_docx.py --sample-files  # Convert only 1st, 4th, and 5th files per volume
    python 1_convert_doc_to_docx.py --only-first    # Convert only 1st file per volume
    python 1_convert_doc_to_docx.py --only-fifth    # Convert only 5th file per volume
    python 1_convert_doc_to_docx.py --single IE2PD17465-VE5CN239/1/file.doc  # Convert single file
"""
