...
```bash
python convert_doc_to_rtf.py --ie-id IE3KG670
python convert_doc_to_rtf.py --ie-id IE3KG670 --method drive
python convert_doc_to_rtf.py --ie-id IE3KG670 --remove-original
```
...
```bash
python convert.py --ie-id IE3KG670 --test-first
python convert.py --rtf-dir ../rtf/IE3KG670 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE3KG670 --single yourfile.rtf
python convert.py --ie-id IE3KG670 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE3KG670
python rtf_check_fix.py --ie-id IE3KG670 --no-fix
python rtf_check_fix.py --ie-id IE3KG670 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE3KG670
python export_outputs.py --ie-id IE3KG670 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE3KG670`
2. RTF→XML: `python convert.py --ie-id IE3KG670 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE3KG670`
4. Export: `python export_outputs.py --ie-id IE3KG670`
