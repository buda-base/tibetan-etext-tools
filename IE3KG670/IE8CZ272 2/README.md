...
```bash
python convert_doc_to_rtf.py --ie-id IE8CZ272
python convert_doc_to_rtf.py --ie-id IE8CZ272 --method drive
python convert_doc_to_rtf.py --ie-id IE8CZ272 --remove-original
```
...
```bash
python convert.py --ie-id IE8CZ272 --test-first
python convert.py --rtf-dir ../rtf/IE8CZ272 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE8CZ272 --single yourfile.rtf
python convert.py --ie-id IE8CZ272 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE8CZ272
python rtf_check_fix.py --ie-id IE8CZ272 --no-fix
python rtf_check_fix.py --ie-id IE8CZ272 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE8CZ272
python export_outputs.py --ie-id IE8CZ272 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE8CZ272`
2. RTF→XML: `python convert.py --ie-id IE8CZ272 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE8CZ272`
4. Export: `python export_outputs.py --ie-id IE8CZ272`
