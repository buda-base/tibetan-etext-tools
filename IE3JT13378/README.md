# IE3JT13378 - Batch RTF to TEI XML Converter

Convert Tibetan RTF documents into TEI XML format.

## Overview

This collection-specific converter processes RTF files from the IE3JT13378 collection, converting them to TEI XML format.
...
└── IE3JT13378/
    └── IE3JT13378_output/
        ├── archive/
        │   └── VE3JT13378_001/
        │       ├── UT3JT13378_001_0001.xml
        │       ├── UT3JT13378_001_0002.xml
        │       └── ...
        └── sources/
            └── VE3JT13378_001/
                ├── volume_001.rtf
...
Process only the IE3JT13378 collection:
```bash
python convert.py --ie-id IE3JT13378
```
...
- `VE3JT13378_001`, index 0 → `UT3JT13378_001_0001`
- `VE3JT13378_001`, index 1 → `UT3JT13378_001_0002`
