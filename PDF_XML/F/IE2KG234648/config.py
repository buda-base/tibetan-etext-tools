...
# Input PDFs (flat)
SOURCES_DIR = BASE_DIR / "IE1KG25273" / "sources"

TOPROCESS_DIR = BASE_DIR / "IE1KG25273" / "toprocess"

OUTPUT_DIR = BASE_DIR / "IE1KG25273_output"
...
# Spec Phase 2: if extraction looks like Latin/Latin-1 instead of Tibetan, retry with
# embedded TT cmap (see tibetan_decode_quality + pdf_cmap_extract).
ENABLE_TIBETAN_DECODE_QUALITY_GATE: bool = True
