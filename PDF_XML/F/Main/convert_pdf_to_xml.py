...
CROP_LEFT_SIDE_FRACTION: float = CROP_LEFT_FRACTION
CROP_RIGHT_SIDE_FRACTION: float = CROP_RIGHT_FRACTION
...
def convert_pdf_to_tei(pdf_path: Path, ve_id: str, sequence: int) -> str:
    ...
    raw_text = extract_pdf_to_text(
        ...
        crop_left=CROP_LEFT_SIDE_FRACTION,
        crop_right=CROP_RIGHT_SIDE_FRACTION,
    )
    if not raw_text:
...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="FRAC",
        help="Fraction of page width to crop from LEFT side.",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="FRAC",
        help="Fraction of page width to crop from RIGHT side.",
    )
    ...
    global CROP_LEFT_SIDE_FRACTION, CROP_RIGHT_SIDE_FRACTION
    ...
    if args.crop_left is not None:
        CROP_LEFT_SIDE_FRACTION = args.crop_left

    if args.crop_right is not None:
        CROP_RIGHT_SIDE_FRACTION = args.crop_right
