...
BASE_DIR = Path(r"C:\Users\user\OneDrive\Desktop\dharmaduta\files")

SOURCES_DIR = BASE_DIR / "IE3KG701" / "sources"
TOPROCESS_DIR = BASE_DIR / "IE3KG701" / "toprocess"
OUTPUT_DIR = BASE_DIR / "IE3KG701_output"
...
CROP_LEFT_FRACTION: float = 0.00
CROP_RIGHT_FRACTION: float = 0.00
