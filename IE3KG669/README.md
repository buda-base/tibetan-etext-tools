...
```bash
python convert_doc_to_rtf.py --ie-id IE3KG669
python convert_doc_to_rtf.py --ie-id IE3KG669 --method drive
python convert_doc_to_rtf.py --ie-id IE3KG669 --remove-original
```
...
```bash
python convert.py --ie-id IE3KG669 --test-first
python convert.py --rtf-dir ../rtf/IE3KG669 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE3KG669 --single yourfile.rtf
python convert.py --ie-id IE3KG669 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE3KG669
python rtf_check_fix.py --ie-id IE3KG669 --no-fix
python rtf_check_fix.py --ie-id IE3KG669 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE3KG669
python export_outputs.py --ie-id IE3KG669 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE3KG669`
2. RTF→XML: `python convert.py --ie-id IE3KG669 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE3KG669`
4. Export: `python export_outputs.py --ie-id IE3KG669`
