#!/usr/bin/env python3
"""
DOCX to TEI XML Converter for IE3CN2232

This script converts DOCX files to TEI XML format using the BasicDOCX parser.
IE3CN2232 DOCX files are already in Unicode, so no Dedris conversion is needed.

IE3CN2232 reads DOCX files from: toprocess/{IE_ID}-{VE_ID}/

Usage:
    python convert_docx_to_xml.py                          # Convert all DOCX files
    python convert_docx_to_xml.py --single IE3CN2232-VE5CN860/file.docx  # Convert single file
    python convert_docx_to_xml.py --single IE3CN2232-VE5CN860/file.docx --sequence 1  # With specific sequence
"""
