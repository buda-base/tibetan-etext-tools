"""
Shared Configuration for IE3CN2232 Conversion Pipeline

This module contains all path configurations and constants used across
the conversion scripts. IE3CN2232 has DOCX files in VE folders (Unicode source).
"""
...
BASE_DIR = Path(r"C:\Users\GANGA GYATSO\OneDrive\Documents\IE1PD100944\IE3CN2232")
...
OUTPUT_DIR = BASE_DIR / "IE3CN2232_output"
...
def extract_ve_id_from_folder(folder_name: str) -> str:
    """
    Extract VE ID from folder name like 'IE3CN2232-VE5CN860' -> 'VE5CN860'.
...
def get_ut_id(ve_id: str, sequence: int = 1) -> str:
    ...
    Examples:
        VE5CN860, 1 -> UT5CN860_0001
        VE5CN860, 2 -> UT5CN860_0002
    """
