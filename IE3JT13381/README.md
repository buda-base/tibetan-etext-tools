# IE3JT13381 - Batch RTF to TEI XML Converter

Convert Tibetan RTF documents into TEI XML format with multiprocessing support.

## Overview

This collection-specific converter processes RTF files from the IE3JT13381 collection, converting them to TEI XML format. It auto-discovers volume folders and handles various folder structures with multiprocessing for optimal performance.
...
└── IE3JT13381/
    └── IE3JT13381_output/
        ├── archive/
        │   └── VE3JT13381_001/
        │       ├── UT3JT13381_001_0001.xml
        │       ├── UT3JT13381_001_0002.xml
        │       └── ...
        └── sources/
            └── VE3JT13381_001/
                ├── volume_001.rtf
...
Process only the IE3JT13381 collection:
```bash
python convert.py --ie-id IE3JT13381
```
...
### convert.py
Main conversion script with multiprocessing support. Handles:
- Collection discovery and volume processing
- Parallel processing with ProcessPoolExecutor
- RTF to TEI XML conversion
- Font size classification
- Text cleaning and normalization
- Progress logging and error handling

### basic_rtf.py
RTF parser for extracting text and formatting information. Features:
- Font table parsing
- Color table parsing
- Text stream extraction with font metadata
- Unicode character handling (`\uN` sequences)
- Special block detection (headers, footers, footnotes, pictures)
- Proper handling of RTF control words and groups

### normalization.py
Unicode normalization for Tibetan text. Provides:
- NFC normalization
- Tibetan-specific Unicode reordering
- Space normalization (including Tibetan tsheg rules)
...
- `VE3JT13381_001`, index 0 → `UT3JT13381_001_0001`
- `VE3JT13381_001`, index 1 → `UT3JT13381_001_0002`
