...
```bash
python convert_doc_to_rtf.py --ie-id IE3CN4660
python convert_doc_to_rtf.py --ie-id IE3CN4660 --method drive
python convert_doc_to_rtf.py --ie-id IE3CN4660 --remove-original
```
...
```bash
python convert.py --ie-id IE3CN4660 --test-first
python convert.py --rtf-dir ../rtf/IE3CN4660 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE3CN4660 --single yourfile.rtf
python convert.py --ie-id IE3CN4660 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE3CN4660
python rtf_check_fix.py --ie-id IE3CN4660 --no-fix
python rtf_check_fix.py --ie-id IE3CN4660 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE3CN4660
python export_outputs.py --ie-id IE3CN4660 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE3CN4660`
2. RTF→XML: `python convert.py --ie-id IE3CN4660 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE3CN4660`
4. Export: `python export_outputs.py --ie-id IE3CN4660`
