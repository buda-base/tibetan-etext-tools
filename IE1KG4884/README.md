...
```bash
python convert_doc_to_rtf.py --ie-id IE1KG4884
python convert_doc_to_rtf.py --ie-id IE1KG4884 --method drive
python convert_doc_to_rtf.py --ie-id IE1KG4884 --remove-original
```
...
```bash
python rtf_check_fix.py --ie-id IE1KG4884
python rtf_check_fix.py --ie-id IE1KG4884 --no-fix
python rtf_check_fix.py --ie-id IE1KG4884 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE1KG4884
python export_outputs.py --ie-id IE1KG4884 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE1KG4884`
2. RTF→XML: `python convert.py --ie-id IE1KG4884 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE1KG4884`
4. Export: `python export_outputs.py --ie-id IE1KG4884`
