...
def convert_rtf_to_tei(rtf_path: Path, doc_path: Path, ve_id: str, ut_id: str = None) -> str:
    """
...
def convert_single_file(rtf_path: Path, ve_id: str, output_dir: Path = None, rtf_dir: Path = None, doc_dir: Path = None, ut_id: str = None):
    """
    ...
    # Convert
    try:
        tei_xml = convert_rtf_to_tei(rtf_path, doc_path, ve_id, ut_id=ut_id)
    except Exception as e:
...
def main():
    ...
    if args.test_first:
        ...
        convert_single_file(rtf_path, ve_id, output_dir, rtf_dir=rtf_dir)
    elif args.single:
        ...
        convert_single_file(rtf_path, ve_id, output_dir, rtf_dir=rtf_dir if args.rtf_dir else None)
    else:
