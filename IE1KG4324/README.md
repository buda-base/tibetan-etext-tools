...
```bash
python convert_doc_to_rtf.py --ie-id IE1KG4324
python convert_doc_to_rtf.py --ie-id IE1KG4324 --method drive
python convert_doc_to_rtf.py --ie-id IE1KG4324 --remove-original
```
...
```bash
python convert.py --ie-id IE1KG4324 --test-first
python convert.py --rtf-dir ../rtf/IE1KG4324 --test-first
```

**Single file or all:**

```bash
python convert.py --ie-id IE1KG4324 --single yourfile.rtf
python convert.py --ie-id IE1KG4324 --all
```
...
```bash
python rtf_check_fix.py --ie-id IE1KG4324
python rtf_check_fix.py --ie-id IE1KG4324 --no-fix
python rtf_check_fix.py --ie-id IE1KG4324 --output report.txt
```
...
```bash
python export_outputs.py --ie-id IE1KG4324
python export_outputs.py --ie-id IE1KG4324 --output-dir /path/to/export
...
1. DOC→RTF: `python convert_doc_to_rtf.py --ie-id IE1KG4324`
2. RTF→XML: `python convert.py --ie-id IE1KG4324 --test-first` or `--all`
3. Check RTF: `python rtf_check_fix.py --ie-id IE1KG4324`
4. Export: `python export_outputs.py --ie-id IE1KG4324`
